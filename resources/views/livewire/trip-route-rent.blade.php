<div class="min-h-screen mt-10 p-6 bg-slate-50 dark:bg-slate-900">
    <div class="">
        <!-- Header -->
        <div class="my-5">
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Trip Route Rent </h1>

        </div>

        <!-- Booking Form Card -->
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6">
            <form class="space-y-6" wire:submit.prevent="tripRouteRent">
                <!-- Total Amount -->
                <div>
                    <label for="rend_date"
                    ...
                    <div class="relative">
                        ...
                        <input type="date" id="rend_date" name="rend_date" required min="0"
