...
<div class="bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-900 dark:text-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <header class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400">Discover amazing hotels for your next trip</p>
        </header>
        ...
        {{-- <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <p class="text-gray-600 dark:text-gray-400 mb-4 sm:mb-0"><span class="font-semibold">{{ $hotels->count() }}</span> hotels found</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            onclick="redirect('{{ route('user.hotel_booking', $hotel->id) }}')"

            >
                <div class="relative overflow-hidden">
                    <img src="{{ $hotel->image }}"
                        alt="Luxury Hotel" class="object-cover w-full h-64 transition duration-300 group-hover:scale-105">
                    ...
                    <div class="absolute text-white bottom-4 left-4">
                        ...
                        <p class="text-sm">${{ $hotel->amount_per_day }} per night</p>
                    </div>
                </div>
            </div>
